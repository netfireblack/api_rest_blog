...
const crear = (req, res) => {
    ...
    // Crear el objeto a guardar y asignarle valores basados en el modelo
    const articulo = new Articulo(parametros);

    // Asignar valores a objeto basado en el modelo (manual o automatico)
    //articulo.titulo = parametros.titulo; // Esta es la forma manual
...
const buscar = (req, res) => {
    ...
    .exec((error, articulosEncontrados) => { // Ejecutar consulta
